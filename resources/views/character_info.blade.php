    ...
    <div class="attributes-mobile" id="attributes-mobile">
        ...
        <div class="attribute-item-mobile">
            <div class="attribute-header-mobile" onclick="toggleMobileAttribute('strength')">
                ...
                <span class="attribute-value-mobile" id="strength-value-mobile">{{ $character->attributes->strength ?? 10 }}</span>
            </div>
            <div class="attribute-content-mobile" id="strength-content-mobile">
                ...
                <div class="skill-item-mobile">
                    ...
                    <button class="mobile-btn" onclick="rollSkill('athletics', 'strength')">
...
<script>
    ...
    function toggleMobileAttribute(attr) {
        const content = document.getElementById(`${attr}-content-mobile`);
        content.classList.toggle('active');
    }

    function syncMobileAttributes() {
        const attributes = ['strength', 'dexterity', 'constitution', 'intelligence', 'wisdom', 'charisma'];

        attributes.forEach(attr => {
            // Синхронизация значений атрибутов
            const value = document.getElementById(attr).value;
            document.getElementById(`${attr}-value-mobile`).textContent = value;

            // Синхронизация модификаторов
            const modifier = getModifier(parseInt(value));
